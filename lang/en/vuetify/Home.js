export default {
  announcementBanner: "Oh yeah, c'est une annonce importante ! Ou alors c'est une publicité !",
  heading1: 'Vuetify',
  ...
  features: [
    {
      ...
      title: "Des fondations de projets prêtes à l'emploi",
      text: 'Vuetify propose 8 templates vue-cli. Du simple HTML au véritable SSR, vous êtes prêts à développer en quelques minutes.'
    },
    {
  ...
  checkFeaturesTitleCtd: "Pour créer d'incroyables interfaces utilisateurs",
  checkFeatures: [
  ...
  authorOfVuetify: 'Auteur de Vuetify',
  support: {
    hasVuetifyHelped: 'Est-ce que Vuetify vous a aidé à créer de superbes applications ?',
    showYourSupport: 'Apportez votre soutien à Vuetify en',
    becomingAPatron: 'devenant un patron'
  },
  becomeSponsor: 'Devenir un Sponsor',
  proudlySponsoredBy: 'Sponsors Patreon',
  callout: 'Boostez votre productivité',
  madeWithVuetify: 'Projets créés avec Vuetify',
